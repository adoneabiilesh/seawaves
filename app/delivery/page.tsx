        ...
        <div className="min-h-screen bg-[#FFFFF0] text-black pb-32 font-sans">
            ...
            <div className="px-4 pt-6 pb-2">
                <div className="flex justify-between items-center mb-4">
                    ...
                    {!user && <Button size="sm" className="rounded-full border-2 border-black bg-white text-black hover:bg-[#DC143C] hover:text-white font-bold" onClick={() => router.push('/login')}>Login</Button>}
                </div>
