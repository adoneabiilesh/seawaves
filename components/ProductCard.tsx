...
export const ProductCard: React.FC<ProductCardProps> = ({ product, onAddToCart, currentLang }) => {
  ...
  const handleAddToCart = () => {
    onAddToCart(product, quantity, modifiers, specialRequest);
    setShowModal(false);
    setQuantity(1);
    setModifiers([]);
    setSpecialRequest('');
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
            ...
            <div className="bg-white rounded-3xl w-full max-w-lg z-10 overflow-hidden shadow-2xl animate-in fade-in zoom-in-95 duration-200 max-h-[90vh] flex flex-col">
                <div className="relative h-48 flex-shrink-0">
                    <img src={product.imageUrl} alt={product.name[currentLang]} className="w-full h-full object-cover" />
                    <button 
                ...
                <div className="p-6 border-t border-gray-100 bg-gray-50 flex items-center gap-4 mt-auto">
                    ...
                    <button 
                        ...
                        className="flex-1 bg-brand-600 hover:bg-brand-700 text-white py-3.5 rounded-xl font-bold shadow-lg shadow-brand-200 transition-all flex items-center justify-center gap-2"
                    >
